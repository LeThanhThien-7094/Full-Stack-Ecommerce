                        ...
                        className='w-full bg-white h-32 my-1 border border-slate-300 rounded grid grid-cols-[128px,1fr]'>
                            ...
                            <div className='px-4 py-2 relative'>
                                ...
                                <div className='flex items-center gap-3 mt-1'>
                                    <button className='border border-red-600 hover:bg-red-600 hover:text-white text-red-600 w-6 h-6 flex justify-center items-center rounded'
                ...
                <div className='mt-5 lg:mt-0 w-full max-w-sm'>
                {
                    loading ? (
                        ...
                        <div className='h-36 bg-slate-200'>
                            <h2 className='text-white bg-red-600 px-4 p-1'>Summary</h2>
