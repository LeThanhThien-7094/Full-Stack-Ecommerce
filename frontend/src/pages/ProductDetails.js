          ...
          {/*product details */}
            {
              loading ? (
                <div className='grid gap-1 w-full'>
                  ...
                  <div className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1 h-6 animate-pulse bg-slate-200 w-full lg:h-8'>
                  ...
                  <div className='w-full'>
                    ...
                    <p className='h-10 bg-slate-200 animate-pulse rounded w-full lg:h-12'></p>
                  </div>
            </div>
              ):(
                <div className='flex flex-col gap-1'>
                  ...
                  <div className='flex items-center gap-3 my-2'>
                    <button className='border-2 border-red-600 rounded px-3 p-1 min-w-[120px] text-red-600 font-medium hover:bg-red-600 hover:text-white' onClick={(e)=>handleBuyProduct(e,data?._id)}>Buy</button>
                    <button className='border-2 border-red-600 rounded px-3 p-1 min-w-[120px] font-medium text-white bg-red-600 hover:text-red-600 hover:bg-white' onClick={(e)=>handleAddToCart(e,data._id)}>Add to Cart</button>
                  </div>
                  <div>
